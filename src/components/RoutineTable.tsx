...
const ROUTINE = [
    ...
    { time: "06:31", description: "Walk", notes: `Roughly ${calculateTimeSince(BIRTHDAY).months*5} walk. If I'm going to do a walk later in the day this can be shorter. Take a number of treats and reward attention, recall, sitting to cross road and loose lead walking` },
    { time: "07:00", description: "Breakfast", notes: `Serve in snuffle rug after walk - 70g of kibble` },
    ...
    { time: "12:00", description: "Lunch", notes: `70g kibble and a small bit of vegetable like celery. Can do some direction training for it or in snuffle mat, traffic cones` },
    ...
    { time: "17:30", description: "Play", notes: `Play with toys/ball till dinner` },
    { time: "18:00", description: "Dinner", notes: `75g kibble. Generally need a poo at sometime after this` },
